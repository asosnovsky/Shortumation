...
export const createMockAuto = ({
  ...
  id: id ?? `${Date.now()}-${Math.random().toString(36).slice(2, 15)}`,
  alias: "Random",
...
export const bigMockAutoList: AutomationData[] = [
  ...
  createMockAuto({ tags: { Room: "Bathroom", Type: "Climate" } }),
  createMockAuto({ tags: { Room: "Living Room", Type: "Climate" } }),
  createMockAuto({ tags: { Type: "Climate" } }),
  createMockAuto({ tags: { Type: "Lights", Routine: "Myself" } }),
  createMockAuto({ tags: { Routine: "DNS", Type: "SSL" } }),
  createMockAuto({
    tags: { Room: "Bedroom", Type: "Lights", Routine: "Baby" },
  }),
  createMockAuto({ tags: { Room: "Office", Type: "Lights" } }),
  createMockAuto({ tags: { Room: "Office" } }),
  createMockAuto(),
  {
    id: "1649947692702",
    alias: "Bed Remote",
