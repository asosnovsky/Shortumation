...
export const InternalPage: FC<{
    ...
    useEffect(() => {
        if (conn.status === 'error') {
            ...
            snackbarKeyHAConKey.current = snackbar.enqueueSnackbar(`Failed to connect to homeassistant due to "${JSON.stringify(conn.error)}"`, {
                "variant": "error",
                "persist": true,
            })
            ...
            snackbarKeyHAConKey.current = snackbar.enqueueSnackbar(`Connecting to websocket...`, {
                "variant": "info",
            })
